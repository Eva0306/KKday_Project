...
**Discount Area** is a collaborative project developed by a four-person team. 

It provides users with a dedicated page to browse and explore special offers and discounts. 

The app dynamically fetches and displays data using RESTful APIs, allowing users to switch between different countries or regions to view localized deals. 

The interface supports various display formats using both TableView and CollectionView to showcase a variety of product cards. 
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Eva0306/KKday_Project.git
